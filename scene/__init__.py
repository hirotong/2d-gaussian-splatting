...
class Scene:
    ...
    def __init__(
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            if args.rotation:
                print("Found transforms_train.json file, assuming RotBlender data set with rotation!")
                scene_info = sceneLoadTypeCallbacks["RotBlender"](args.source_path, args.white_background, args.eval)
            else:
