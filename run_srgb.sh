...
for scene in ${scenes[@]}; do
    ...
    (
        ...
        CUDA_VISIBLE_DEVICES='2' python render.py -m output/${scene}_pbr_gs --brdf_dim 0 --sh_degree -1 --brdf_mode envmap --brdf_env 512 --shading gs
        CUDA_VISIBLE_DEVICES='2' python metrics.py -m output/${scene}_pbr_gs
    ) 
    wait
    # (
